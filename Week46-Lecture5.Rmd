...
---
This is the second Readme file for the Data Science and HR analytics course, trying out experiments on the code for lecture 5.
...
colnames(credx) returns the names of the columns in the sparse matrix.
...
colnames(credx_higher_interactions)
```
